...
```{r}
bird_number <- filter(bird_type, n >= 5)
```
...
ggplot(bird_type, aes(egg_mass_median, male_mass_median)) +
  ...
  scale_x_log10() +
  scale_y_log10() +
  geom_point(color = "red", data = bird_number, size = 4, alpha = 0.8) +
  geom_text_repel(aes(label = type, y = male_mass_median * 0.9), data = bird_number, size = 4)
