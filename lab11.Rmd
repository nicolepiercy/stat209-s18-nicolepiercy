...
ggplot(birds, aes(male_mass, egg_mass, alpha(0.15))) +
  ...
  scale_y_log10() + 
  scale_x_log10() +
  geom_point(color="red", data=parrots, size = 2) +
  annotate("text", x = 78, y = 3, label = "Parrots", color = "red", size = 5)
...
ggplot(birds, aes(male_mass, egg_mass, alpha(0.15))) +
  ...
  annotate("text", x= 220, y= 101, label= "Tropicbird", color= "red")
...
ggplot(birds, aes(egg_mass, clutch_size)) +
  geom_point() +
  geom_smooth(method = "lm", color = "black", se = FALSE, linetype = "dashed", size = 0.5) +
  annotate("point", x = 190, y = 14.78, color = "red", size= 4) +
  annotate("text", x= 190, y= 15.1, label= "Australian Brush Turkey", color = "red", size= 4) +
  ylab("Size of Clutch") +
  xlab("Mass of Egg") +
  ggtitle("Relationship Between Clutch Size and Egg Mass")
